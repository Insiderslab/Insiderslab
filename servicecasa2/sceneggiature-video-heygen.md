# Friul Service Casa — 3 video per la landing v2 (Fabbro · Elettricista · Idraulico)

**Formato:** 16:9, 1080p, 45–55 secondi, player in stile YouTube dentro la landing
...
## Struttura comune (vale per tutti e 3)

| Tempo | Blocco | Obiettivo |
|---|---|---|
...
## 🔑 VIDEO 1 — Pronto intervento FABBRO

**Titolo player:** "Chiuso fuori casa? Ecco cosa fare (e chi chiamare)"
**Miniatura:** avatar con mano sulla porta + testo grande "CHIUSO FUORI?" + logo

| # | Tempo | Parlato avatar (voiceover) | A schermo / B-roll |
|---|---|---|---|
...
## ⚡ VIDEO 2 — Pronto intervento ELETTRICISTA

**Titolo player:** "Salta la corrente? 30 secondi per capire cosa fare"
**Miniatura:** avatar che indica un quadro elettrico + testo "SALTA LA CORRENTE?"

| # | Tempo | Parlato avatar | A schermo / B-roll |
|---|---|---|---|
...
## 💧 VIDEO 3 — Pronto intervento IDRAULICO

**Titolo player:** "Perdita d'acqua? Fai subito questa cosa"
**Miniatura:** avatar con rubinetto che gocciola + testo "PERDITA D'ACQUA?"
...
## 🎬 Come realizzarli su HeyGen

### 0. Connettore: stato attuale
- Il connettore collegato è **HyperFrames by HeyGen**. Produce video **motion graphics** (testi animati, icone, transizioni, voiceover e sottotitoli). **Non genera avatar parlanti.**
- La creazione (`compose`) funziona **solo da Claude.ai web o desktop**. Da Claude Code, cioè questa sessione, HeyGen la blocca. Per usarlo: aprire una chat su claude.ai con il connettore attivo e incollare i prompt pronti in `prompt-hyperframes.md`.
- **Avatar con il logo sulla divisa:** si fanno in **HeyGen web** (Avatar IV / Digital Twin). Vedi il punto 1.
- **Montaggio consigliato:** l'avatar che parla (HeyGen web) si alterna con gli inserti grafici (HyperFrames), oppure si usa il video HyperFrames come "versione solo grafica" per ads e social.
...
Dal logo ufficiale:
- **Rosso brand:** `#E30613` circa (rosso vivo del logo: "Friul", scudo, scie)
- **Nero:** `#111111` (casa, "Service Casa")
- **Bianco:** `#FFFFFF` per sfondi e testi su nero
- **CTA e numero di telefono:** rosso su bianco, oppure bianco su rosso
- **Font:** il logo usa un sans-serif **bold, corsivo e squadrato**. Alternative Google Fonts vicine: **Saira Condensed ExtraBold Italic** per "Friul" e i titoli, **Saira Semi Condensed SemiBold** per i testi. Se il sito usa altri font, vince il sito.
- **Elemento grafico ricorrente:** le **scie di velocità** rosse del logo. Usarle nelle transizioni e dietro al numero di telefono: comunicano "arriviamo subito".
- **Logo:** PNG trasparente in versione colori e in versione bianca per gli sfondi neri. Serve il file originale, non lo screenshot.

### 3. Voce e pronuncia
- Voce italiana naturale. Con il Digital Twin conviene usare la **voce clonata** del titolare.
- Usare la **pronuncia personalizzata** per "Friul Service Casa" → "Friùl Sèrvis Casa".
- Il numero va scritto nel copione come si dice: "tre sette sette, zero otto zero, zero sette sette quattro", altrimenti la sintesi lo legge male.

### 4. Montaggio in AI Studio
- Una **scena per ogni riga** delle tabelle. Si alternano primo piano e mezzo busto con B-roll a tutto schermo e l'avatar in un riquadro.
- B-roll: libreria stock di HeyGen oppure, **meglio, 5–10 clip vere** girate col telefono (furgone, attrezzi, mani al lavoro).
- **Sottotitoli sempre attivi**: molti guardano senza audio. Font e colori del brand.
- Numero di telefono visibile **per tutti gli ultimi 10–12 secondi**.
- Stessa intro (2s, logo), stessa grafica 1-2-3 e stessa chiusura per tutti e 3: devono sembrare una **serie**.

### 5. Export e inserimento nella landing
- Export **MP4 1080p 16:9**. In più una **versione 9:16** degli stessi video per Reel, TikTok e Google Ads: si ottiene con il resize di HeyGen, controllando le inquadrature.
- **Nella landing:** caricarli su YouTube **non in elenco** con **miniatura personalizzata** e incorporarli con lazy-load, così la pagina non rallenta. Mettere un pulsante "Chiama ora" **sotto ogni player**, non solo dentro il video.
- Posizione: ogni video accanto alla card del servizio corrispondente.

### Checklist prima della generazione
- [ ] Il cliente ha confermato tempi, zone, preventivo e garanzie
- [ ] Nome del tecnico / titolare
- [ ] Colori HEX e font dalla landing
- [ ] Logo PNG
